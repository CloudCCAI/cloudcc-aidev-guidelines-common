...
15. Development must stop when login, preflight identity, assignment, branch, file-scope checks, or hard identity gate prerequisites fail.
...
- optionally calls `scripts/check-assignment.py` for task, branch, and file-scope authorization
