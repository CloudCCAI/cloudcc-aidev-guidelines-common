...
echo "11. For a GitHub PR gate example, copy templates/github-workflows/check-assignment.yml into .github/workflows/"
echo "12. For manager team status, run: python3 \"${ROOT_DIR}/scripts/summarize-team-status.py\" \"${STATE_DIR_PATH}\" --write"
echo "13. Run validation: python3 \"${ROOT_DIR}/scripts/validate-state.py\" \"${STATE_DIR_PATH}\""
